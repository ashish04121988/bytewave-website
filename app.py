...
with hero_right:
    st.markdown("""
    <div style="background: rgba(11,31,58,0.97); min-height:92vh; display:flex; flex-direction:column; justify-content:center; align-items:center; gap:20px; padding:40px 24px;">
        <div class="stat-badge" style="width:200px;">
            <div class="stat-badge-number">3–4x</div>
            <div class="stat-badge-label">Pipeline Growth</div>
        </div>
        <div class="stat-badge" style="width:200px; animation-delay:1s;">
            <div class="stat-badge-number">50%</div>
            <div class="stat-badge-label">Faster Deal Cycles</div>
        </div>
        <div class="stat-badge" style="width:200px; animation-delay:2s;">
            <div class="stat-badge-number">15+</div>
            <div class="stat-badge-label">Technology Partners</div>
        </div>
        <div style="margin-top:8px; text-align:center;">
            <div style="font-size:11px; color:#334155; letter-spacing:1px; text-transform:uppercase; margin-bottom:12px;">Trusted by</div>
            <div style="font-size:13px; color:#475569; font-weight:600;">SMEs · Mid-Market · Enterprise</div>
        </div>
    </div>
    """, unsafe_allow_html=True)
...
<div class="partner-strip">
    <div style="text-align:center; margin-bottom:18px; font-size:12px; color:#475569; letter-spacing:2px; text-transform:uppercase; font-weight:700;">
...
# ─── ABOUT SNAPSHOT ──────────────────────────────────────────────────────────
st.markdown("""
<div style="padding: 60px 60px 0; background: #0B1F3A; text-align:center;">
...
with about_left:
    st.markdown("""
    <div style="padding: 0 40px 60px 60px; background: #0B1F3A;">
        <h2 style="font-size:clamp(32px,4vw,48px); font-weight:800; letter-spacing:-1px; color:#F1F5F9; margin-bottom:20px; line-height:1.15; text-align:left;">
            Your Technology &amp; <span class="gradient-text">Revenue Growth</span> Partner
        </h2>
        <p style="font-size:16px; color:#94A3B8; line-height:1.85; margin-bottom:16px;">
        ...
        <p style="font-size:16px; color:#94A3B8; line-height:1.85; margin-bottom:28px;">
            ...
            <strong style="color:#E2E8F0;">Bytewave Digital was created to simplify that journey.</strong>
        </p>
        <div style="display:flex; flex-direction:column; gap:10px; margin-bottom:32px;">
            <div style="display:flex; align-items:center; gap:12px; font-size:14px; color:#CBD5E1;">
                <span style="color:#2563EB; font-weight:700;">✓</span> Vendor-neutral technology advisory
            </div>
            <div style="display:flex; align-items:center; gap:12px; font-size:14px; color:#CBD5E1;">
                <span style="color:#2563EB; font-weight:700;">✓</span> Access to 15+ leading global software partners
            </div>
            <div style="display:flex; align-items:center; gap:12px; font-size:14px; color:#CBD5E1;">
                <span style="color:#2563EB; font-weight:700;">✓</span> Faster, simplified procurement process
            </div>
            <div style="display:flex; align-items:center; gap:12px; font-size:14px; color:#CBD5E1;">
                <span style="color:#2563EB; font-weight:700;">✓</span> Outcome-driven, ROI-focused approach
            </div>
        </div>
...
with about_right:
    st.markdown("""
    <div style="padding: 0 60px 60px 0; background: #0B1F3A;">
    ...
    with tab1:
        ...
        with col_txt:
            ...
            <div style="padding-left:24px;">
                ...
                <h3 style="font-size:30px; font-weight:800; color:#F1F5F9; margin-bottom:16px; letter-spacing:-0.5px;">CRM Solutions</h3>
                ...
                <ul style="list-style:none; display:flex; flex-direction:column; gap:10px; margin-bottom:28px;">
                    <li style="font-size:14px; color:#CBD5E1; display:flex; align-items:center; gap:10px;"><span style="color:#2563EB;">→</span> Scalability evaluation &amp; comparison</li>
                    <li style="font-size:14px; color:#CBD5E1; display:flex; align-items:center; gap:10px;"><span style="color:#2563EB;">→</span> Integration compatibility mapping</li>
                    <li style="font-size:14px; color:#CBD5E1; display:flex; align-items:center; gap:10px;"><span style="color:#2563EB;">→</span> User adoption assessment</li>
                    <li style="font-size:14px; color:#CBD5E1; display:flex; align-items:center; gap:10px;"><span style="color:#2563EB;">→</span> Commercial comparison &amp; vendor shortlisting</li>
                    <li style="font-size:14px; color:#CBD5E1; display:flex; align-items:center; gap:10px;"><span style="color:#2563EB;">→</span> Right-fit recommendation</li>
                </ul>
    ...
    with tab2:
        ...
        with col_txt:
            ...
            <div style="padding-left:24px;">
                ...
                <h3 style="font-size:30px; font-weight:800; color:#F1F5F9; margin-bottom:16px; letter-spacing:-0.5px;">Marketing Automation Tools</h3>
                <p style="font-size:15px; color:#94A3B8; line-height:1.8; margin-bottom:20px;">
                ...
                <ul style="list-style:none; display:flex; flex-direction:column; gap:10px; margin-bottom:28px;">
                    <li style="font-size:14px; color:#CBD5E1; display:flex; align-items:center; gap:10px;"><span style="color:#2563EB;">→</span> Lead generation platforms</li>
                    <li style="font-size:14px; color:#CBD5E1; display:flex; align-items:center; gap:10px;"><span style="color:#2563EB;">→</span> Campaign management tools</li>
                    ...
                    <li style="font-size:14px; color:#CBD5E1; display:flex; align-items:center; gap:10px;"><span style="color:#2563EB;">→</span> Martech stack evaluation</li>
                    <li style="font-size:14px; color:#CBD5E1; display:flex; align-items:center; gap:10px;"><span style="color:#2563EB;">→</span> ROI-focused selection</li>
                </ul>
    ...
    with tab3:
        ...
        with col_txt:
            ...
            <div style="padding-left:24px;">
                ...
                <h3 style="font-size:30px; font-weight:800; color:#F1F5F9; margin-bottom:16px; letter-spacing:-0.5px;">Cloud &amp; IT Solutions</h3>
                <p style="font-size:15px; color:#94A3B8; line-height:1.8; margin-bottom:20px;">
                ...
                <ul style="list-style:none; display:flex; flex-direction:column; gap:10px; margin-bottom:28px;">
                    <li style="font-size:14px; color:#CBD5E1; display:flex; align-items:center; gap:10px;"><span style="color:#2563EB;">→</span> Public, private &amp; hybrid cloud evaluation</li>
                    <li style="font-size:14px; color:#CBD5E1; display:flex; align-items:center; gap:10px;"><span style="color:#2563EB;">→</span> Infrastructure comparison</li>
                    <li style="font-size:14px; color:#CBD5E1; display:flex; align-items:center; gap:10px;"><span style="color:#2563EB;">→</span> Cost optimization</li>
                    <li style="font-size:14px; color:#CBD5E1; display:flex; align-items:center; gap:10px;"><span style="color:#2563EB;">→</span> Scalability planning</li>
    ...
    with tab4:
        ...
        with col_txt:
            ...
            <div style="padding-left:24px;">
                ...
                <h3 style="font-size:30px; font-weight:800; color:#F1F5F9; margin-bottom:16px; letter-spacing:-0.5px;">Agentic AI Solutions</h3>
                <p style="font-size:15px; color:#94A3B8; line-height:1.8; margin-bottom:20px;">
                ...
                <ul style="list-style:none; display:flex; flex-direction:column; gap:10px; margin-bottom:28px;">
                    ...
                    <li style="font-size:14px; color:#CBD5E1; display:flex; align-items:center; gap:10px;"><span style="color:#2563EB;">→</span> Decision-making &amp; productivity tools</li>
                    <li style="font-size:14px; color:#CBD5E1; display:flex; align-items:center; gap:10px;"><span style="color:#2563EB;">→</span> Use-case alignment</li>
                    <li style="font-size:14px; color:#CBD5E1; display:flex; align-items:center; gap:10px;"><span style="color:#2563EB;">→</span> AI readiness assessment</li>
                    <li style="font-size:14px; color:#CBD5E1; display:flex; align-items:center; gap:10px;"><span style="color:#2563EB;">→</span> Business value mapping</li>
                </ul>
    ...
    with tab5:
        ...
        with col_txt:
            ...
            <div style="padding-left:24px;">
                ...
                <h3 style="font-size:30px; font-weight:800; color:#F1F5F9; margin-bottom:16px; letter-spacing:-0.5px;">HR &amp; Finance Software</h3>
                <p style="font-size:15px; color:#94A3B8; line-height:1.8; margin-bottom:20px;">
                ...
                <ul style="list-style:none; display:flex; flex-direction:column; gap:10px; margin-bottom:28px;">
                    <li style="font-size:14px; color:#CBD5E1; display:flex; align-items:center; gap:10px;"><span style="color:#2563EB;">→</span> Workforce management platforms</li>
                    <li style="font-size:14px; color:#CBD5E1; display:flex; align-items:center; gap:10px;"><span style="color:#2563EB;">→</span> Financial reporting tools</li>
                    <li style="font-size:14px; color:#CBD5E1; display:flex; align-items:center; gap:10px;"><span style="color:#2563EB;">→</span> Payroll &amp; compliance solutions</li>
                    <li style="font-size:14px; color:#CBD5E1; display:flex; align-items:center; gap:10px;"><span style="color:#2563EB;">→</span> Operational efficiency evaluation</li>
                    <li style="font-size:14px; color:#CBD5E1; display:flex; align-items:center; gap:10px;"><span style="color:#2563EB;">→</span> Compliance alignment</li>
                </ul>
    ...
    with tab6:
        ...
        with col_txt:
            ...
            <div style="padding-left:24px;">
                ...
                <h3 style="font-size:30px; font-weight:800; color:#F1F5F9; margin-bottom:16px; letter-spacing:-0.5px;">Observability for Cloud-Scale Apps</h3>
                <p style="font-size:15px; color:#94A3B8; line-height:1.8; margin-bottom:20px;">
                ...
                <ul style="list-style:none; display:flex; flex-direction:column; gap:10px; margin-bottom:28px;">
                    <li style="font-size:14px; color:#CBD5E1; display:flex; align-items:center; gap:10px;"><span style="color:#2563EB;">→</span> Application monitoring</li>
                    <li style="font-size:14px; color:#CBD5E1; display:flex; align-items:center; gap:10px;"><span style="color:#2563EB;">→</span> Infrastructure visibility</li>
                    <li style="font-size:14px; color:#CBD5E1; display:flex; align-items:center; gap:10px;"><span style="color:#2563EB;">→</span> Performance analytics</li>
                    <li style="font-size:14px; color:#CBD5E1; display:flex; align-items:center; gap:10px;"><span style="color:#2563EB;">→</span> Reliability engineering tools</li>
...
# ─── HOW WE WORK ─────────────────────────────────────────────────────────────
st.markdown("""
<div style="padding: 80px 60px 40px; background: #0B1F3A; text-align:center;">
...
with hw_c1:
    st.markdown("""
    <div style="padding: 0 12px 80px; background: #0B1F3A;">
...
# ─── TESTIMONIALS ────────────────────────────────────────────────────────────
st.markdown("""
<div style="padding: 80px 60px 40px; background: #081729; text-align:center;">
...
with t_c1:
    st.markdown("""
    <div style="padding: 0 12px 80px; background: #081729;">
